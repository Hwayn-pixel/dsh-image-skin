...
function tokenLanguage(scheme, mode) {
    ...
    return [
        ...
        `  --dsw-specific-input-major: ${rung(-0.24)} !important;`,
        `  --dsw-specific-login-input: ${rung(-0.24)} !important;`,
        `  --dsw-specific-selector: ${rung(-0.1)} !important;`,
        `  --dsw-specific-menu: ${rung(-0.06)} !important;`,
        `  --dsw-specific-tip: ${rung(0.02)} !important;`,
        `  --dsw-specific-bubble: ${rung(-0.02)} !important;`,
        `  --dsw-specific-bubble-highlight: ${rung(0.08)} !important;`,
        `  --dsw-alias-tooltip-bg: ${rung(0.06)} !important;`,
        `  --dsw-alias-toast-bg: ${rung(0.06)} !important;`,
        `  --dsw-alias-bg-module-platform: ${rung(-0.14)} !important;`,
        `  --dsw-alias-bg-multi-select: ${rung(-0.14)} !important;`,
        ...
        // states climb a rung
        `  --dsw-alias-interactive-bg-hover: rgba(var(--dsh-skin-tone-high), .5) !important;`,
        `  --dsw-alias-interactive-bg-active: rgba(var(--dsh-skin-tone-high), .72) !important;`,
        `  --dsw-alias-interactive-bg-hover-solid: rgba(var(--dsh-skin-tone-high), .88) !important;`,
        `  --dsw-alias-interactive-bg-hover-accent: rgba(var(--dsh-skin-accent), .26) !important;`,
        // buttons
        `  --dsw-alias-button-tool-bar-fill: rgba(var(--dsh-skin-tone-raised), .72) !important;`,
        `  --dsw-alias-button-tool-bar-fill-invisible: rgba(var(--dsh-skin-tone-raised), .36) !important;`,
        `  --dsw-alias-button-tool-bar-hover: rgba(var(--dsh-skin-tone-high), .82) !important;`,
        `  --dsw-alias-button-elevated-fill: rgba(var(--dsh-skin-tone-high), .9) !important;`,
        `  --dsw-alias-button-floating-fill: rgba(var(--dsh-skin-tone-raised), .95) !important;`,
        `  --dsw-alias-button-ghost-active-fill: rgba(var(--dsh-skin-tone-high), .72) !important;`,
        ...
        `  --dsw-specific-sidebar-nav-item-active: rgba(var(--dsh-skin-tone-high), .9) !important;`,
        `  --dsh-sidebar-nav-item-active: rgba(var(--dsh-skin-tone-high), .9) !important;`,
        `  --dsw-specific-sidebar-nav-item-hover: rgba(var(--dsh-skin-tone-raised), .72) !important;`,
...
function deriveScheme(palette, mode, light, depth = 2) {
    ...
    const rung = dark
        ...
        : [0.014, 0.045, 0.090, 0.135, 0.180][Math.max(0, Math.min(4, depth))] ?? 0.090;
